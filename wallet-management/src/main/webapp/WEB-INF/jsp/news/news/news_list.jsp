					...
					<div class="row">
						...
						<table style="margin-top:5px;">
							<tr>
								<td>
									<div class="nav-search">
										<span class="input-icon">
											<input type="text" placeholder="这里输入标题" class="nav-search-input" id="nav-search-input" autocomplete="off" name="keywords" value="${pd.keywords }" placeholder="这里输入标题"/>
								...
								<c:if test="${QX.add == 1 }">
								 <td style=""><a class="btn btn-mini btn-success" onclick="add();">新增</a></td>
								</c:if>
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<%-- <td class='center'>${var.PICTURE_URL}</td>
											<td class='center'>${var.PICTURE_NAME}</td>
											<td class='center'>${var.RICH_TEXT}</td>
											<td class='center'>${var.BROWSE_COUNT}</td> --%>
