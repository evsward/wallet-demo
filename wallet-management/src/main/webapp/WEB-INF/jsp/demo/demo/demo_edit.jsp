				...
				<div class="row">
					...
					<form action="demo/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">存款:</td>
								<td><input type="number" name="CK" id="CK" value="${pd.CK}" maxlength="32" placeholder="这里输入存款" title="存款" style="width:98%;"/></td>
							</tr>
							<tr>
