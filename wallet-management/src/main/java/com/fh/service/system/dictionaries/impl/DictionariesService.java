...
public class DictionariesService implements DictionariesManager{
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<PageData> listAllFromGeneralCode(PageData pd)throws Exception{
		return (List<PageData>)dao.findForList("DictionariesMapper.listAllFromGeneralCode", pd);
	}
