...
import com.yhyy.wallet.service.SystemCodeGroupService;
import com.yhyy.wallet.service.SystemGeneralCodeService;
/**
 * 
...
public class ColdWalletTool {
	...
	* @author Anne
	...
	public String createEtherColdWallet() throws Exception{
		EtherWalletUtil.EtherWallet wallet = EtherWalletUtil.createWallet();
	...
	* @author Anne
	 */
	public EtherWalletUtil.EtherWallet getColdWallet(){
		EtherWalletUtil.EtherWallet coldWallet = new EtherWalletUtil.EtherWallet();
	...
	* @author Anne
	...
	private void getAccountSeed(String address){
		try {
			EtherWalletUtil.EtherWallet wallet = getColdWallet();
			if(wallet != null){
