...
public class EcoWalletController {
	...
	public AjaxResponse sendMoney(HttpServletRequest request,@RequestBody WithdrawLog withdrawLog){
    	...
    	if(withdrawLog==null||StringUtils.isBlank(withdrawLog.getAccount())||StringUtils.isBlank(withdrawLog.getToAddress())||!Validator.isMoney4(withdrawLog.getMoney().toString())){
