...
import com.yhyy.constant.WalletConstant;
import com.yhyy.exception.RuntimeServiceException;
import com.yhyy.util.AES;
import com.yhyy.util.OrderGenerater;
import com.yhyy.wallet.entity.DigitalCoin;
import com.yhyy.wallet.entity.RechargeLog;
import com.yhyy.wallet.entity.UserCoin;
import com.yhyy.wallet.entity.WithdrawLog;
import com.yhyy.wallet.mapper.DigitalCoinMapper;
import com.yhyy.wallet.mapper.RechargeLogMapper;
import com.yhyy.wallet.mapper.UserCoinMapper;
import com.yhyy.wallet.mapper.WithdrawLogMapper;
...
public class LiteWalletAsync implements Runnable{
    ...
    private static  String wallertRootPath = "C:\\wallet";
    
    public static NetworkParameters params = MainNetParams.get();
//    public static NetworkParameters params = TestNet3Params.get();

    private static String userName ="litecoin";
//    private static String userName ="litecoin-test";
...
//                                withdrawLog.setFree(new BigDecimal(Utils.bitcoinValueToFriendlyString(tx.REFERENCE_DEFAULT_MIN_TX_FEE)));
                              ...
                              //回调
                                /*try {
                                	...
                                	String withdrawCallback = withDrawService.confirmCallback(userCoin.getAddress(), digitalCoin.getId(), withdrawLog.getAccount(), tx.getHashAsString(), withdrawLog.getMoney());
